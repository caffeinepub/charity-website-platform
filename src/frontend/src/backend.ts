...
export class Backend implements backendInterface {
    ...
    async getAllEntries(): Promise<Array<ContactEntry>> {
        if (this.processError) {
            try {
    ...
    async submitContactEntry(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactEntry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
